...
const Banner = () => {
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-between' style={{
      ...
      <div className="banner-content w-100 container text-white">
        ...
        <div className="lead-text">Live gaming with lots of other games. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</div>
